...
train_dir = pre_data_dir + '/train_data/train_words'
val_dir = pre_data_dir + '/train_data/val_words_small'
train_text_dir = pre_data_dir + '/train_data/train_words_gt.txt'
val_text_dir = pre_data_dir + '/train_data/val_words_gt.txt'
...
if __name__ == '__main__':
    train(train_dir, val_dir, train_text_dir, val_text_dir)

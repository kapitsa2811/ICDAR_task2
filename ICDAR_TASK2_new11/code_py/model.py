...
def stacked_bidirectional_rnn(RNN, num_units, num_layers, inputs, seq_lengths):
    ...
    for _ in range(num_layers):
        with tf.variable_scope(None, default_name="bidirectional-rnn"):
            ...
            rnn_cell_fw = tf.nn.rnn_cell.DropoutWrapper(rnn_cell_fw, input_keep_prob=0.5, output_keep_prob=1.0)
            rnn_cell_bw = tf.nn.rnn_cell.DropoutWrapper(rnn_cell_bw, input_keep_prob=0.5, output_keep_prob=1.0)
